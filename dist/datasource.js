      ...
      _export('GenericDatasource', GenericDatasource = function () {
        ...
        _createClass(GenericDatasource, [{
          ...
          value: function interpolateVariable(value, variable) {
            ...
            const returnMultiValue = quotedValues[multiCount];
            multiCount++;

            return returnMultiValue;
          }
        }, {
          ...
          value: function buildQueryParameters(options) {
            ...
            const newTargetQuery = options.targets[0];
            for (let variable of _this.templateSrv.variables) {
              if (variable.multi == true && variable.current.value.length > 1) {
                for (let i = 0; i < variable.current.value.length - 1; i++) {
                  options.targets.push(newTargetQuery);
                }
              }
            }
